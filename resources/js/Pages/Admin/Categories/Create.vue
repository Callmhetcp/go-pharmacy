            ...
            <div class="mx-auto max-w-4xl px-4 py-6 sm:px-6 lg:px-8">
                ...
                <div class="mb-8">
                    ...
                    <p class="mt-2 text-sm text-slate-500">
                        Add a new category to your pharmacy catalogue.
                    </p>
                </div>
                    ...
                    <div class="grid gap-6">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                class="w-full rounded-xl border border-slate-200 bg-white px-4 py-3 text-sm text-slate-900 outline-none transition focus:border-green-500 focus:ring-2 focus:ring-green-500/20"
                            />
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                class="w-full resize-none rounded-xl border border-slate-200 bg-white px-4 py-3 text-sm text-slate-900 outline-none transition focus:border-green-500 focus:ring-2 focus:ring-green-500/20"
                            ></textarea>
                        ...
                        <div>
                            ...
                            <input
                                ...
                                @change="handleImage"
                                class="block w-full rounded-xl border border-slate-200 bg-white text-sm text-slate-600 file:mr-4 file:border-0 file:bg-green-50 file:px-4 file:py-3 file:font-semibold file:text-green-700 hover:file:bg-green-100"
                            />
                        ...
                        >
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-xs text-slate-500">
                                    Active categories are available on the
                                    customer store.
                                </p>
                            </div>
                        </label>
