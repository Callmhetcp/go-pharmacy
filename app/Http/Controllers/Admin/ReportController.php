...
class ReportController extends Controller
{
    ...
    public function index(Request $request): Response
    {
        ...
        */
        ...
        |--------------------------------------------------------------------------
        |
        | Both POS and online sales are stored in orders.
        |
        | POS:
        | cashier_id IS NOT NULL
        |
        | Online:
        | cashier_id IS NULL
        |
        ...
        */
        ...
        |--------------------------------------------------------------------------
        |
        | Include zero-sales days so the chart remains continuous.
        |
        */
        ...
        */
        ...
        |--------------------------------------------------------------------------
        |
        | Completed POS + online order items are combined.
        |
        */
        ...
        */
        ...
        |--------------------------------------------------------------------------
        |
        | Expiry is tracked at purchase-item/batch level.
        |
        | This is important for pharmacy inventory because the same
        | product can have multiple batches with different expiry dates.
        |
        */
